...
if (isset($_POST['btnSignIn'])) {
    ...
    $accounts = [
        "adviser@gmail.com" => ["password" => "12345", "redirect" => "adviserDashboard.php"],
        "teacher@gmail.com" => ["password" => "12345", "redirect" => "teacherDashboard.php"],
        "principal@gmail.com" => ["password" => "12345", "redirect" => "principalDashboard.php"],
        "admin@gmail.com" => ["password" => "12345", "redirect" => "adminDashboard.php"]
    ];

    if (array_key_exists($email, $accounts) && $accounts[$email]['password'] === $password) {
